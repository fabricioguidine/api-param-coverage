...
class ParallelProcessor:
    ...
    def process_parallel(self, items: List[Any], func: Callable, *args, **kwargs) -> List[Any]:
        """
        ...
        with self.executor_class(max_workers=self.max_workers) as executor:
            # Submit all tasks
            future_to_index = {executor.submit(func, item, *args, **kwargs): i for i, item in enumerate(items)}
    ...
    def map_parallel(self, items: List[Any], func: Callable) -> List[Any]:
        """
...
def process_endpoints_parallel(
    endpoints: List[Dict[str, Any]], process_func: Callable, max_workers: Optional[int] = None
) -> List[Any]:
    """
