...
class OutputManager:
    ...
    def create_run_directory(
        self, schema_name: str, schema_url: Optional[str] = None, run_timestamp: Optional[str] = None
    ) -> Path:
        """
    ...
    def create_manifest(
        ...
        manifest = {
            ...
            "schema": {"name": schema_name, "url": schema_url},
    ...
    def create_run_readme(
        self, run_dir: Path, schema_name: str, schema_url: Optional[str] = None, summary: Optional[Dict[str, Any]] = None
    ) -> Path:
        """
...
"""
    ...
    def _generate_short_id(self, schema_name: str, timestamp: str) -> str:
        ...
        hash_input = f"{schema_name}_{timestamp}".encode()
