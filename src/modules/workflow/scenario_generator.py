...
def generate_gherkin_scenarios(
    filtered_analysis_data: Dict[str, Any], processed_data: Dict[str, Any], llm_prompter: LLMPrompter, schema_name: str
) -> Optional[str]:
    """
    ...
    prompt = llm_prompter.create_prompt(processed_data, task="gherkin", analysis_data=filtered_analysis_data)
...
def export_scenarios(gherkin_content: str, schema_name: str, run_output_dir: Path, run_timestamp: str) -> List[Path]:
    """
