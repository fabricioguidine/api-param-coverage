...
from ..brd import BRDSchema, SchemaCrossReference
...
def apply_coverage_filter(
    analysis_data: Dict[str, Any], coverage_percentage: float = DEFAULT_COVERAGE_PERCENTAGE
    ...
    filtered_analysis_data = {**analysis_data, "endpoints": selected_endpoints}
...
def apply_brd_filter(
    analysis_data: Dict[str, Any], brd: BRDSchema, run_output_dir: Optional[Path] = None, run_timestamp: Optional[str] = None
) -> Tuple[Dict[str, Any], Dict[str, Any]]:
    """
