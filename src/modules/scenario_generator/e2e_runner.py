...
def generate_bdd(spec_path: str, output_dir: str) -> list[str]:
    """
    Backwards compat placeholder.

    Expected behavior:
    - parse the API spec at spec_path
    - generate .feature files under output_dir
    - return list of generated file paths
    """
    raise NotImplementedError(
        "generate_bdd() not implemented yet in refactor"
    )
