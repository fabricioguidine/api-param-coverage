...
from src.utils.validators import ValidationError, validate_api_key, validate_url
...
class TestInteractiveSelectionMenus:
    ...
    def test_cancel_from_selection_menu(self, mock_input):
        ...
        result = InteractiveSelector.select_from_list(options, "Select item", allow_cancel=True)
    ...
    def test_navigate_file_selection_menu(self, mock_input, capsys):
        ...
        result = InteractiveSelector.select_from_list(files, "Select file", display_func=lambda x: x)
    ...
    def test_select_with_display_function(self, mock_input):
        ...
        result = InteractiveSelector.select_from_list(items, "Select item", display_func=lambda x: x["name"])
...
class TestErrorHandlingRecovery:
    ...
    def test_handle_network_timeout_gracefully(self, mock_input, capsys):
        ...
        result = ErrorHandler.handle_error(error, "downloading schema", ["Retry download", "Use different URL", "Exit"])
