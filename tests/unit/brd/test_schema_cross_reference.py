...
from src.modules.brd.brd_schema import BRDRequirement, BRDSchema, RequirementPriority
...
class TestSchemaCrossReference:
    ...
    def sample_analysis_data(self):
        ...
        return {
            "endpoints": [
                {"path": "/users/{id}", "method": "GET", "parameters": [{"name": "id", "type": "string", "location": "path"}]},
                {"path": "/users", "method": "POST", "parameters": [{"name": "name", "type": "string", "location": "body"}]},
                {"path": "/posts", "method": "GET", "parameters": []},
            ]
        }
    ...
    def test_empty_brd_coverage(self, cross_ref, sample_analysis_data):
        ...
        empty_brd = BRDSchema(brd_id="BRD-EMPTY", title="Empty BRD", description="Test", api_name="API")
