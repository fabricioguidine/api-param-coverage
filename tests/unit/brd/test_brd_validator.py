...
from src.modules.brd.brd_schema import BRDRequirement, BRDSchema
...
class TestBRDValidator:
    ...
    def sample_analysis_data(self):
        ...
        return {
            "endpoints": [
                {"path": "/users/{id}", "method": "GET", "parameters": []},
                {"path": "/users", "method": "POST", "parameters": []},
                {"path": "/products", "method": "GET", "parameters": []},
            ]
        }
    ...
    def test_fuzzy_match_endpoint(self, validator):
        ...
        swagger_endpoints = {("/users/123", "GET"), ("/users/{id}", "GET"), ("/products/{productId}", "GET")}
    ...
    def test_suggest_similar_endpoint(self, validator):
        ...
        swagger_endpoints = {("/users", "GET"), ("/users/{id}", "GET"), ("/products", "GET")}
    ...
    def test_validate_empty_brd(self, validator, sample_analysis_data):
        ...
        empty_brd = BRDSchema(brd_id="BRD-EMPTY", title="Empty BRD", description="Test", api_name="Test API", requirements=[])
    ...
    def test_validate_case_insensitive_methods(self, validator):
        ...
        analysis_data = {"endpoints": [{"path": "/users", "method": "GET", "parameters": []}]}
    ...
    def test_fuzzy_match_no_match(self, validator):
        ...
        swagger_endpoints = {("/users", "GET"), ("/products", "GET")}
    ...
    def test_suggest_similar_endpoint_partial_match(self, validator):
        ...
        swagger_endpoints = {("/api/v1/users", "GET"), ("/api/v1/products", "GET"), ("/api/v2/users", "GET")}
