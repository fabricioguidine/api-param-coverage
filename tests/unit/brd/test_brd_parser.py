...
class TestBRDParser:
    ...
    def parser(self, temp_input_dir, temp_output_dir):
        ...
        return BRDParser(api_key="test-key", model="gpt-4", input_dir=temp_input_dir, output_dir=temp_output_dir)

    def test_parser_initialization(self, temp_input_dir, temp_output_dir):
        """Test BRDParser initialization."""
        parser = BRDParser(input_dir=temp_input_dir, output_dir=temp_output_dir)
    ...
    def test_parser_without_api_key(self, temp_input_dir, temp_output_dir):
        ...
        parser = BRDParser(api_key=None, input_dir=temp_input_dir, output_dir=temp_output_dir)
