...
from src.modules.brd.brd_schema import BRDRequirement, BRDSchema, BRDTestScenario, RequirementPriority, RequirementStatus
...
class TestBRDSchema:
    ...
    def test_brd_schema_creation(self):
        ...
        brd = BRDSchema(brd_id="BRD-001", title="Test BRD", description="Test description", api_name="Test API")
    ...
    def test_brd_schema_to_dict(self):
        ...
        brd = BRDSchema(brd_id="BRD-001", title="Test BRD", description="Test", api_name="API")
    ...
    def test_brd_get_all_endpoints(self):
        ...
        requirement1 = BRDRequirement(
            requirement_id="REQ-001", title="Test 1", description="Test", endpoint_path="/users/{id}", endpoint_method="GET"
        )
        requirement2 = BRDRequirement(
            requirement_id="REQ-002", title="Test 2", description="Test", endpoint_path="/users", endpoint_method="POST"
        )

        brd = BRDSchema(
            brd_id="BRD-001", title="Test", description="Test", api_name="API", requirements=[requirement1, requirement2]
        )
    ...
    def test_brd_get_requirements_for_endpoint(self):
        ...
        requirement = BRDRequirement(
            requirement_id="REQ-001", title="Test", description="Test", endpoint_path="/users/{id}", endpoint_method="GET"
        )

        brd = BRDSchema(brd_id="BRD-001", title="Test", description="Test", api_name="API", requirements=[requirement])
...
class TestBRDRequirement:
    ...
    def test_requirement_to_dict(self):
        ...
        req = BRDRequirement(
            requirement_id="REQ-001", title="Test", description="Test", endpoint_path="/users", endpoint_method="GET"
        )
...
class TestBRDTestScenario:
    ...
    def test_scenario_to_dict(self):
        ...
        scenario = BRDTestScenario(scenario_id="SCEN-001", scenario_name="Test", description="Test", test_steps=["Step 1"])
